...
class FavoriteWidget : AppWidgetProvider() {
    ...
    companion object{
        ...
        private const val TOAST_ACTION = "com.example.githubperson.TOAST_ACTION"
        const val EXTRA_ITEM = "com.example.githubperson.EXTRA_ITEM"
        ...
        private fun updateAppWidget(
            ...
            views.setEmptyView(R.id.stackView, R.id.containerEmptyView)
